...
models["Переменные"].hasOne(models["Функция_принадлежности"],{onDelete:'cascade'})//функция_принадлежности
...
models["Переменные"].hasOne(models["Оценки_основных_лп"],{onDelete:'cascade'})//переменная
