...
models.Пользователь.hasOne(models.Студент,{onDelete:'cascade'})
models.Направление.hasOne(models.Студент,{onDelete:'cascade'})//код_направления
...
models.Компетенция.hasOne(models.Индикаторы_достижения_компетенций,{onDelete:'cascade'})//код_компетенций
models.Компетенция.hasOne(models.Оценки_компетенций,{onDelete:'cascade'})//код_компетенций

models.Индикаторы_достижения_компетенций.hasOne(models.Индикатор_зув,{onDelete:'cascade'})//код_индикатора
models.Индикаторы_достижения_компетенций.hasOne(models.Оценки_индикаторов,{onDelete:'cascade'})//код_индикатора

models.Результаты_обучения_зув.hasOne(models.Индикатор_зув,{onDelete:'cascade'})//код_зув
...
models.Результаты_обучения_зув.hasOne(models.Нечеткая_классфикация_зув,{onDelete:'cascade'})//код_зув
...
models.Объект_контроля.hasOne(models.Объект_контроля_зув,{onDelete:'cascade'})//id_объекта_контроля
